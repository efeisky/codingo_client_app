...
import './../css/StandartQuestion.css'
export const StandartQuestion = ({content, questionLevel, optionA, optionB, optionC, optionD, answer,isSpeaking,isAnswering}) => {
  ...
  return (
    <div className='standartQuestionArea'>
      <div 
